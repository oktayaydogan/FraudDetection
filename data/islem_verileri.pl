...
% İşlem kayıtları: ID, Kullanıcı, İşlem Miktarı, Zaman Damgası, Konum, Cihaz,
%                 Davranış Süresi, İşlem Türü, IP Adresi, Ödeme Yöntemi, Alan (E-posta veya Telefon)
...
islem(5,  kullanici1, 0,   8,  'Türkiye', 'Safari',  20, 'degisim',  '192.168.1.1', 'Banka Kartı', 'user1@example.com').
...
islem(8,  kullanici2, 0,   20, 'Türkiye', 'Edge',    15, 'degisim',  '192.168.1.1', 'Havale',      'user2@example.com').
islem(9, kullanici2, 3000, 12, 'Türkiye', 'Safari', 50, 'islem', '192.168.1.1', 'Kredi Kartı', 'user2@example.com').


% Kullanıcı 3
islem(10, kullanici3,  500, 14, 'Türkiye', 'Safari', 15, 'islem', '192.168.1.1', 'Kredi Kartı', 'user3@example.com').
islem(11, kullanici3, 600,  7, 'ABD',     'Firefox',18, 'iade',     '10.0.0.2',    'E-Cüzdan',    'user3@example.com').
islem(12, kullanici3, 400,  9, 'Türkiye', 'Chrome',  22, 'islem',    '192.168.1.1', 'Kredi Kartı', 'user2@example.com').
...
islem(15, kullanici4, 0,   28, 'Fransa',  'Safari',  35, 'degisim',  '10.0.0.3',    'Banka Kartı', 'user4@example.com').
islem(16, kullanici4, 1500,32, 'Almanya', 'Safari',  50, 'islem',    '10.0.0.3',    'Banka Kartı', 'user4@example.com').

% Ekstra senaryolar
islem(17, kullanici5, 2000,50, 'Türkiye', 'Chrome',  60, 'islem',    '192.168.1.5', 'Kredi Kartı', 'user5@example.com').
islem(18, kullanici5, 100, 52, 'Türkiye', 'Safari',  25, 'iade',     '192.168.1.5', 'Banka Kartı', 'user5@example.com').
islem(19, kullanici5, 0,   51, 'Türkiye', 'Safari',  20, 'degisim',  '192.168.1.5', 'Banka Kartı', 'user5@example.com').
...
islem(31, kullanici8, 500,25, 'Türkiye', 'Safari', 200, 'islem',     '192.168.1.20','E-Cüzdan',    'user8@example.com'). %% DEĞİŞTİRİLDİ (Eskiden 35 idi)
