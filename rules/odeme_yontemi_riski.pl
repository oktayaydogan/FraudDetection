...
odeme_yontemi_kontrol(OdemeYontemi) :-
    findall((Kullanici, Zaman), 
        ...
        Islemler),
    writeln(['[DEBUG] Ödeme yöntemiyle ilgili işlemler:', OdemeYontemi, '=>', Islemler]),
    kontrol_et(Islemler).
...
kontrol_et([(Kullanici1, Zaman1), (Kullanici2, Zaman2) | Kalan]) :-
    ...
    writeln(['[ALERT] Kısa sürede farklı hesaplarda aynı ödeme yöntemi kullanıldı:', Kullanici1, Kullanici2, Zaman1, Zaman2]),
